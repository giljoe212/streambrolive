...
interface AddUserModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (userData: { username: string; email: string; password: string }) => Promise<void>;
}
...
const AddUserModal: React.FC<AddUserModalProps> = ({ isOpen, onClose, onSave }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError('Gagal menambahkan pengguna. Pastikan email/username belum terdaftar.');
      ...
      <div className="bg-gray-800 rounded-lg w-full max-w-md p-6 relative">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex justify-end space-x-3">
            ...
            <button
              type="submit"
              className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-800 flex items-center"
              disabled={isLoading}
            >
              {isLoading ? (
                <>
